...
- `[$execute-github-repo-metadata-and-community-maintenance] reconcile this repo's GitHub surface`
- `use the GitHub repo maintenance skill and bring the repo metadata into shape`
- `[$execute-github-repo-metadata-and-community-maintenance] check whether gh can access this repo, then fix what is safely derivable`
- `[$execute-github-repo-metadata-and-community-maintenance] inspect current GitHub metadata first, then reconcile it with the README and repo content`
- `[$execute-github-repo-metadata-and-community-maintenance] the token may be in this file, use it only if gh auth is missing`
